...
$(window).load(function() {
	...
	var $optionSets = $('nav.category ul'),
     ...
     $('.eventport').hide().before('<a href="#" id="toggle-event" class="event"></a>');
    $('a#toggle-event').click(function() {
        $('.eventport').slideToggle(500);
        $('.styleport').slideUp(500);
        $('.educationport').slideUp(500);
        return false;
    });

     $('.styleport').hide().before('<a href="#" id="toggle-style" class="style"></a>');
         $('a#toggle-style').click(function() {
         $('.styleport').slideToggle(500);
         $('.eventport').slideUp(500);
         $('.educationport').slideUp(500);
        return false;
    });

       $('.educationport').hide().before('<a href="#" id="toggle-education" class="style"></a>');
       $('a#toggle-education').click(function() {
       $('.educationport').slideToggle(500);
       $('.styleport').slideUp(500);
       $('.eventport').slideUp(500);
        return false;
    });
